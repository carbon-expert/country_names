...
const countries = [
    ...
    {name: "Åland Islands",code: "AX",phone: 358,currency: "EUR"},
    ...
    {name: "Antigua & Barbuda",code: "AG",phone: 1268,currency: "XCD"},
    ...
    {name: "Caribbean Netherlands",code: "BQ",phone: 599,currency: "USD"},
    {name: "Bosnia & Herzegovina",code: "BA",phone: 387,currency: "BAM"},
    ...
    {name: "Congo - Brazzaville",code: "CG",phone: 242,currency: "XAF"},
    {name: "Congo - Kinshasa",code: "CD",phone: 242,currency: "CDF"},
    ...
    {name: "Curaçao",code: "CW",phone: 599,currency: "ANG"},
    {name: "Cyprus",code: "CY",phone: 357,currency: "EUR"},
    {name: "Czechia",code: "CZ",phone: 420,currency: "CZK"},
    ...
    {name: "Falkland Islands (Islas Malvinas)",code: "FK",phone: 500,currency: "FKP"},
    ...
    {name: "Heard & McDonald Islands",code: "HM",phone: 0,currency: "AUD"},
    {name: "Vatican City",code: "VA",phone: 39,currency: "EUR"},
    ...
    {name: "Myanmar (Burma)",code: "MM",phone: 95,currency: "MMK"},
    ...
    {name: "Curaçao",code: "AN",phone: 599,currency: "ANG"},
    ...
    {name: "Pitcairn Islands",code: "PN",phone: 64,currency: "NZD"},
    ...
    {name: "Réunion",code: "RE",phone: 262,currency: "EUR"},
    {name: "Romania",code: "RO",phone: 40,currency: "RON"},
    {name: "Russia",code: "RU",phone: 70,currency: "RUB"},
    {name: "Rwanda",code: "RW",phone: 250,currency: "RWF"},
    {name: "St. Barthélemy",code: "BL",phone: 590,currency: "EUR"},
    {name: "St. Helena",code: "SH",phone: 290,currency: "SHP"},
    {name: "St. Kitts & Nevis",code: "KN",phone: 1869,currency: "XCD"},
    {name: "St. Lucia",code: "LC",phone: 1758,currency: "XCD"},
    {name: "St. Martin",code: "MF",phone: 590,currency: "EUR"},
    {name: "St. Pierre & Miquelon",code: "PM",phone: 508,currency: "EUR"},
    {name: "St. Vincent & Grenadines",code: "VC",phone: 1784,currency: "XCD"},
    {name: "Samoa",code: "WS",phone: 684,currency: "WST"},
    {name: "San Marino",code: "SM",phone: 378,currency: "EUR"},
    {name: "São Tomé & Príncipe",code: "ST",phone: 239,currency: "STD"},
    ...
    {name: "Serbia",code: "CS",phone: 381,currency: "RSD"},
    ...
    {name: "South Georgia & South Sandwich Islands",code: "GS",phone: 500,currency: "GBP"},
    ...
    {name: "Svalbard & Jan Mayen",code: "SJ",phone: 47,currency: "NOK"},
    ...
    {name: "Trinidad & Tobago",code: "TT",phone: 1868,currency: "TTD"},
    ...
    {name: "Turks & Caicos Islands",code: "TC",phone: 1649,currency: "USD"},
    ...
    {name: "U.S. Outlying Islands",code: "UM",phone: 1,currency: "USD"},
    ...
    {name: "British Virgin Islands",code: "VG",phone: 1284,currency: "USD"},
    {name: "U.S. Virgin Islands",code: "VI",phone: 1340,currency: "USD"},
    {name: "Wallis & Futuna",code: "WF",phone: 681,currency: "XPF"},
